...
namespace OVOLV2
{
    public partial class fSub1 : Form
    {
        ...
        private int mnMode;
        private List<String> _mode = new List<String> { "BEFMonarchyPlan1", "ChristmasCounters1", "HKMonarchyPlan1", "LandlockedDecision1" };
        private List<int> _weightings = new List<int> { 1, 3, 7, 10 };
        private List<int> _addsto = new List<int> { 0, 0, 0, 0 };
        private List<String> _country1 = new List<String> { "France","Italy","Spain","SouthAfrica","Venezuela"};
        private List<String> _country2 = new List<String> { "Germany", "Greece", "UK", "NorthKorea", "Somalia" };
        ...
        private void fClick(int nCol, int nRow)
        {
            ...
            {
                nPos = (nCol - 1-4) * 4 + nRow;
                nType = fHoletype(msShuffle4, nPos);
                if (nType == 1)
                {
                    fPlace2(3, nPos);
                }
        ...
        private void fReset()
        {
            ...
            int nCountry1 = rnd1.Next(1, 6);
            int nCountry2 = rnd1.Next(1, 6);
            ...
            lblCountry1.Text = _country1[nCountry1 - 1];
            lblCountry2.Text = _country2[nCountry2 - 1];
        ...
        private void fPlace2(int nType, int nSquare)
        {
            ...
            msShuffle4 = msShuffle4.Substring(0, nSquare * 2 - 2) + sTwo + msShuffle4.Substring(nSquare * 2, (16 - nSquare) * 2);
        }
        ...
        private void fUpdateDisplay()
        {
            ...
            //2
            nType = fHoletype(msShuffle4, 5);
            fPeek(nType, nRotate, ref _pic);
            picC21.Image = _pic.Image;
            nType = fHoletype(msShuffle4, 6);
            fPeek(nType, nRotate, ref _pic);
            picC22.Image = _pic.Image;
            nType = fHoletype(msShuffle4, 7);
            fPeek(nType, nRotate, ref _pic);
            picC23.Image = _pic.Image;
            nType = fHoletype(msShuffle4, 8);
            fPeek(nType, nRotate, ref _pic);
            picC24.Image = _pic.Image;

            //3
            nType = fHoletype(msShuffle4, 9);
            fPeek(nType, nRotate, ref _pic);
            picC31.Image = _pic.Image;
            nType = fHoletype(msShuffle4, 10);
            fPeek(nType, nRotate, ref _pic);
            picC32.Image = _pic.Image;
            nType = fHoletype(msShuffle4, 11);
            fPeek(nType, nRotate, ref _pic);
            picC33.Image = _pic.Image;
            nType = fHoletype(msShuffle4, 12);
            fPeek(nType, nRotate, ref _pic);
            picC34.Image = _pic.Image;

            //4
            nType = fHoletype(msShuffle4, 13);
            fPeek(nType, nRotate, ref _pic);
            picC41.Image = _pic.Image;
            nType = fHoletype(msShuffle4, 14);
            fPeek(nType, nRotate, ref _pic);
            picC42.Image = _pic.Image;
            nType = fHoletype(msShuffle4, 15);
            fPeek(nType, nRotate, ref _pic);
            picC43.Image = _pic.Image;
            nType = fHoletype(msShuffle4, 16);
            fPeek(nType, nRotate, ref _pic);
            picC44.Image = _pic.Image;
        ...
        private void fPeek(int nValue, int nRotate, ref PictureBox _pic2)
        {
            ...
            {
                Name = "pictureBox4",
                Image = Image.FromFile(@"F BEFMonarchyPlan1.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture5 = new PictureBox
            {
                Name = "pictureBox5",
                Image = Image.FromFile(@"F BEFMonarchyPlan2.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture6 = new PictureBox
            {
                Name = "pictureBox6",
                Image = Image.FromFile(@"F BEFMonarchyPlan3.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture7 = new PictureBox
            {
                Name = "pictureBox7",
                Image = Image.FromFile(@"F BEFMonarchyPlan4.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture8 = new PictureBox
            {
                Name = "pictureBox8",
                Image = Image.FromFile(@"F ChristmasCounters1.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture9 = new PictureBox
            {
                Name = "pictureBox9",
                Image = Image.FromFile(@"F ChristmasCounters2.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture10 = new PictureBox
            {
                Name = "pictureBox10",
                Image = Image.FromFile(@"F ChristmasCounters3.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture11 = new PictureBox
            {
                Name = "pictureBox11",
                Image = Image.FromFile(@"F ChristmasCounters4.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture12 = new PictureBox
            {
                Name = "pictureBox12",
                Image = Image.FromFile(@"F HKMonarchyPlan1.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture13 = new PictureBox
            {
                Name = "pictureBox13",
                Image = Image.FromFile(@"F HKMonarchyPlan2.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture14 = new PictureBox
            {
                Name = "pictureBox14",
                Image = Image.FromFile(@"F HKMonarchyPlan3.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture15 = new PictureBox
            {
                Name = "pictureBox15",
                Image = Image.FromFile(@"F HKMonarchyPlan4.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture16 = new PictureBox
            {
                Name = "pictureBox16",
                Image = Image.FromFile(@"F LandlockedDecision1.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture17 = new PictureBox
            {
                Name = "pictureBox17",
                Image = Image.FromFile(@"F LandlockedDecision2.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture18 = new PictureBox
            {
                Name = "pictureBox18",
                Image = Image.FromFile(@"F LandlockedDecision3.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture19 = new PictureBox
            {
                Name = "pictureBox19",
                Image = Image.FromFile(@"F LandlockedDecision4.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
